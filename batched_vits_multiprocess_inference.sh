...
noise_scale_w=0.8
length_scale=1
vits_multispeaker=false # to detect if multispeaker model is used

# Check if the correct number of arguments are provided
if [ "$#" -lt 6 ]; then
    echo "Usage: $0 --csv_file <csv_file> --gpu_ids <gpu_ids> --max_process <max_process> --batch_size <batch_size> --vits_config <vits_config> --vits_checkpoint <vits_checkpoint> [--audio_save_dir <audio_save_dir> --noise_scale <noise_scale> --noise_scale_w <noise_scale_w> --length_scale <length_scale> --vits_multispeaker true]"
...
for ((i=0; i<max_process; i++)); do
    ...
    python batched_vits_inference.py \
        ...
        --vits_multispeaker "$vits_multispeaker" \
